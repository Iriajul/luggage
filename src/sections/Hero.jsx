    ...
    <div className="max-w-7xl mx-auto px-6 pt-12 pb-20 grid md:grid-cols-2 gap-12 items-start">
      ...
      <div>
        <div className="inline-flex items-center gap-2 bg-emerald-100 text-emerald-700 text-sm px-5 py-2 rounded-3xl mb-6">
          ...
          <span className="font-medium">Built for Bangladeshi families, students, and expats</span>
        </div>
        ...
        <h1 className="text-5xl md:text-6xl font-bold leading-none tracking-tighter text-slate-900 mb-6">
          ...
          <span className="text-emerald-600">Bangladesh and the world.</span>
        </h1>
        ...
        <div className="flex gap-6 mt-10 text-sm text-slate-600">
          <div className="flex items-center gap-2">✅ Verified traveler profiles</div>
          <div className="flex items-center gap-2">✅ Clear luggage space availability</div>
          <div className="flex items-center gap-2">✅ Direct messaging before booking</div>
        </div>
      </div>

      {/* Right side - Popular Routes (exact match) */}
      <PopularRoutes />
    </div>
  );
}